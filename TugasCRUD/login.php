            ...
            <div class="col-md-6 text-center login" style="background-image: url('img/bg/TULT.jpeg');">
                ...
                <form action="" method="post">
                    <div class="form-group user">
                        <input type="text" class="form-control w-50 mx-auto" placeholder="Masukkan Username" name="username" autocomplete="off" required>
                    </div>
                    <div class="form-group my-5">
                        <input type="password" class="form-control w-50 mx-auto" placeholder="Masukkan Password" name="password" autocomplete="off" required>
                    </div>
